...
class Commons
{
    ...
    static function getFilterHtml($sFilter)
    {
        ...
        $sHtml .= $tInput[$sFilter] . " <img class='delete_filter filter_delete_".$sFilter."' src='".SITE_URL."/themes/images/deleteIcon.png' title='Supprimer le filtre' alt='Supprimer le filtre'/>";
	...
	static function getRegionAcf()
	{
		$listeACF = array();
		$listeACF['Aquitania'] = 'Aquitania';
		$listeACF['Belgique'] = 'Belgique'; 
		$listeACF['BFC'] = 'Bourgogne Franche-Comté';
		$listeACF['CA'] = 'Champagne Ardennes';
		$listeACF['EDP'] = 'Envers de Paris';		
		$listeACF['Est'] = 'Est';   
		$listeACF['ECA'] = 'Esterel Cote d’Azur';
		$listeACF['IdF'] = 'Ile-de-France';
		$listeACF['La Réunion'] = 'La Réunion'; 
		$listeACF['MAP'] = 'Méditerranée Provence';
		$listeACF['MC'] = 'Massif Central';
		$listeACF['MP'] = 'Midi Pyrénées';
		$listeACF['N'] = 'Normandie';
		$listeACF['Restonica'] = 'Restonica';
		$listeACF['RA'] = 'Rhône Alpes';
		$listeACF['VLB'] = 'Val-de-Loire Bretagne';
		$listeACF['VD'] = 'Voie Domitienne';		
		return $listeACF;
	}	
}
